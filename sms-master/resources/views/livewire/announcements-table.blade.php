           ...
           @foreach($announcements as $announcement)
               <tr>
                   ...
                   <td class="border px-4 py-2 rounded-full">
                       <a href="{{url('edit-teacher/'.$announcement->id)}}"><img src="{{asset('uploads/announcement/'.$announcement->photo)}}" width="30" height="30" alt="image" class="border rounded-full"></a>
                   </td>
                   <td class="border px-4 py-2">{{ $announcement->photo }}</td>
                   <td class="border px-4 py-2">{{ $announcement->id}}</td>
                   <td class="border px-4 py-2">{{ $announcement->title }}</td>
                   <td class="border px-4 py-2">{{ $announcement->message}}</td>
                 
                   <td class="flex items-center border px-4 py-2">
                   
                       <a href="{{url('edit-announcement/'.$announcement->id)}}" >  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#3F83F8" class="w-6 h-6 mr-2">
                       ...
                       <a href="{{url('delete-announcement/'.$announcement->id)}}"> <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#F05252" class="w-6 h-6" >
