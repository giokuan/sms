                    ...
                    <div class="flex items-center justify-between">
                        <label for="remember_me" class="inline-flex items-center">
                            <input id="remember_me" type="checkbox"
                                class="text-blue-700 border border-blue-300 rounded focus:border-blue-500 focus:ring-1 focus:ring-blue-700 dark:border-blue-600 dark:bg-dark-eval-1 dark:focus:ring-offset-dark-eval-1"
                                name="remember">
