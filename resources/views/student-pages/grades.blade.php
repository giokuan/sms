...
<div class="grid grid-cols-4 gap-4">
    ...
    <div class="col-span-7 md:col-start-1 md:col-end-3 inline-flex flex-col gap-2 bg-white dark:bg-dark-eval-1 p-4 rounded-lg">
        ...
        <div class="border-b-2 py-2 border-[#001F52] dark:border-[#FFFFFF]">
            <p>Subject Name : Subject Number 1</p>
            <p>Subject teacher : Teacher Number 1</p>
        </div>
    ...
    <div class="col-span-7 md:col-start-3 md:col-end-5 inline-flex flex-col gap-2 bg-white dark:bg-dark-eval-1 p-4 rounded-lg">
        {{-- Subject Name and teacher goes here --}}
        <div class="border-b-2 py-2 border-[#001F52] dark:border-[#FFFFFF]">
            <p>Subject Name : Subject Number 2</p>
            <p>Subject teacher : Teacher Number 2</p>
        </div>
