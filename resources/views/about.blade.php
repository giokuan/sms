                ...
                <div class="flex flex-col items-center lg:flex-row">
                    ...
                    <div class="w-full lg:w-1/2">
                        ...
                        <blockquote class="flex items-center justify-between w-full col-span-1 p-6 bg-white rounded-lg shadow" data-rounded="rounded-lg" data-rounded-max="rounded-full">
                            <div class="flex flex-col pr-8">
                                <div class="relative pl-12">
                                    <svg class="absolute left-0 w-10 h-10 text-indigo-900 fill-current" data-primary="indigo-500"  viewBox="0 0 100 125">
                                        <path d="M30.7 42c0 6.1 12.6 7 12.6 22 0 11-7.9 19.2-18.9 19.2C12.7 83.1 5 72.6 5 61.5c0-19.2 18-44.6 29.2-44.6 2.8 0 7.9 2 7.9 5.4S30.7 31.6 30.7 42zM82.4 42c0 6.1 12.6 7 12.6 22 0 11-7.9 19.2-18.9 19.2-11.8 0-19.5-10.5-19.5-21.6 0-19.2 18-44.6 29.2-44.6 2.8 0 7.9 2 7.9 5.4S82.4 31.6 82.4 42z"></path>
                                    </svg>
                                    <p class="mt-2 text-sm text-gray-600 sm:text-base lg:text-sm xl:text-base">have seen the immediate need for a robust School Management System to handle the enormous amount of administrative work involved in managing school records. And for most schools, manual recording is still a common practice.</p>
                                </div>
        
                                <h3 class="pl-12 mt-3 text-sm font-medium leading-5 text-indigo-900 truncate sm:text-base lg:text-sm ">
                                    GIO KUAN <br>  
                                    <span class="mt-1 text-sm leading-5 text-gray-500 truncate">CEO FOUNDER</span>
                                </h3>
                            </div>
                        ...
                        <blockquote class="flex items-center justify-between w-full col-span-1 p-6 mt-4 bg-white rounded-lg shadow" data-rounded="rounded-lg" data-rounded-max="rounded-full">
                            <div class="flex flex-col pr-8">
                                <div class="relative pl-12">
                                    <svg class="absolute left-0 w-10 h-10 text-indigo-900 fill-current" data-primary="indigo-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 125">
                                        <path d="M30.7 42c0 6.1 12.6 7 12.6 22 0 11-7.9 19.2-18.9 19.2C12.7 83.1 5 72.6 5 61.5c0-19.2 18-44.6 29.2-44.6 2.8 0 7.9 2 7.9 5.4S30.7 31.6 30.7 42zM82.4 42c0 6.1 12.6 7 12.6 22 0 11-7.9 19.2-18.9 19.2-11.8 0-19.5-10.5-19.5-21.6 0-19.2 18-44.6 29.2-44.6 2.8 0 7.9 2 7.9 5.4S82.4 31.6 82.4 42z"></path>
                                    </svg>
                                    <p class="mt-2 text-sm text-gray-600 sm:text-base lg:text-sm xl:text-base">Specializes in both back-end coding and front-end coding when creating applications, websites and software.</p>
                                </div>
                        ...
                        <blockquote class="flex items-center justify-between w-full col-span-1 p-6 mt-4 bg-white rounded-lg shadow" data-rounded="rounded-lg" data-rounded-max="rounded-full">
                            <div class="flex flex-col pr-8">
                                <div class="relative pl-12">
                                    ...
                                    <p class="mt-2 text-sm text-gray-600 sm:text-base lg:text-sm xl:text-base">Ensure that security and compliance are not compromised in a bid to release products on an accelerated timeline.</p>
                                </div>
        
                                <h3 class="pl-12 mt-3 text-sm font-medium leading-5 text-indigo-900 truncate sm:text-base lg:text-sm ">
                                    BRYANT ROSILLO <br>
                                    <span class="mt-1 text-sm leading-5 text-gray-500 truncate">DEV OPS</span>
                                </h3>
