                    ...
                    <div>
                        ...
                        @else
                            ...
                            <div x-data="{ open: false }">
                                <button class="bg-[#012560] rounded-md text-sky-50 text-xl font-light border-solid px-3 md:px-4 lg:px-6  py-1 cursor-pointer duration-300  hover:scale-110 hover:bg-opacity-75 hover:text-sky-200"
                                ...
                                >
                                    ...
                                    <div class="flex flex-col max-w-lg bg-[#004AAD] shadow-2xl rounded-lg border-2 border-[#FFFFFF] p-6 gap-3 text-center text-light-900" @click.away="open = false">
                                        <div class="flex justify-between mb-2 text-[#FFFFFF]">
