                    ...
                    <div>
                        @auth
                            <a href="{{ url('/dashboard') }}">
                                <button 
                                class="bg-[#012560] rounded-md text-sky-50 text-lg font-light border-solid px-1 md:px-2 lg:px-3 py-1 cursor-pointer duration-300  hover:scale-110 hover:bg-opacity-75 hover:text-sky-200">
                                    Go to Dashboard
                                </button>
                            </a>
                        @else
