...
<div class="w-full relative mt-4 shadow-2xl rounded my-24 overflow-hidden">
    ...
    <div class="grid grid-cols-12 bg-white ">
      ...
      <div class="col-span-12 md:border-solid md:border-l md:border-black md:border-opacity-25 h-full pb-12 md:col-span-10 dark:bg-gray-600">
        <div class="px-4 pt-4">
          <form action="post" action="{{url('update-student')}}" class="flex flex-col space-y-8 dark:bg-gray-600" enctype="multipart/form-data">
            <input type="hidden" name="id" value="{{$data->id}}">
            @csrf
            ...
            <div class="flex flex-col space-y-4 md:space-y-0 md:flex-row md:space-x-4">
                <div class="form-item w-full">
                    ...
                    <input type="text" value="{{$data->lastname}}" class="w-full appearance-none text-black text-opacity-50 rounded shadow py-1 px-2  mr-2 focus:outline-none focus:shadow-outline focus:border-blue-200" id="lastname" name="lastname">
                </div>
            ...
            <div class="flex flex-col space-y-4 md:space-y-0 md:flex-row md:space-x-4">  
                ...
                <div class="form-item w-full">
                    ...
                    <input type="text" value="{{$data->email}}" class="w-full appearance-none text-black text-opacity-50 rounded shadow py-1 px-2 mr-2 focus:outline-none focus:shadow-outline focus:border-blue-200" id="email" name="email">
                </div>                 
            ...
            <div class="flex flex-col space-y-4 md:space-y-0 md:flex-row md:space-x-4">
                ...
                <div class="form-item w-full">
                    ...
                    <input type="text" value="{{$data->phone}}" class="w-full appearance-none text-black text-opacity-50 rounded shadow py-1 px-2 mr-2 focus:outline-none focus:shadow-outline focus:border-blue-200" id="phone" name="phone">
                </div>
            ...
            <div class="flex flex-col space-y-4 md:space-y-0 md:flex-row md:space-x-4">
                ...
                <div class="form-item w-full">
                    ...
                    <input type="text" value="{{$data->fathersname}}" class="w-full appearance-none text-black text-opacity-50 rounded shadow py-1 px-2 mr-2 focus:outline-none focus:shadow-outline focus:border-blue-200 "  id="fathersname" name="fathersname" >
                </div>
...
{{-- 
   ...
   --}}         <button type="submit" class="bg-sky-500 border-gray-200 rounded py-2 px-8 shadow-lg">Update</button>
                ...
                <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-0" for="photo">
                    Change Photo
                </label>
