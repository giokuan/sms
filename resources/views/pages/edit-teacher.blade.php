<x-app-layout>
    <x-slot name="header">
        ...
        <form method="post" action="{{url('update-teacher')}}" class="flex flex-col space-y-8" enctype="multipart/form-data">
        ...
        <div class="w-full relative mt-4 shadow-2xl rounded my-24 overflow-hidden">
            <div class="top h-60 w-full bg-blue-600 overflow-hidden relative" >
              ...
              <div class="flex flex-col justify-center items-center relative h-full bg-black bg-opacity-50 text-white">
                ...
                <img src="{{asset('uploads/teachers/'.$data->photo)}}"  alt="image" class="h-24 w-24 object-cover rounded-full">
