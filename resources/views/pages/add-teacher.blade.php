                  ...
                  {{-- <form method="post" action="{{url('save-student')}}" class="flex flex-col space-y-8" enctype="multipart/form-data">
                    ...
                    <div class="flex flex-col space-y-4 md:space-y-0 md:flex-row md:space-x-4">  
                        ...
                        <div class="form-item w-full">
                            ...
                            <input type="text" value="{{old('email')}}" class="w-full appearance-none text-black  rounded shadow py-1 px-2 mr-2 mb-4 focus:outline-none focus:shadow-outline focus:border-blue-200 dark:bg-gray-600 dark:text-white" id="email" name="email">
                            @error('email')
