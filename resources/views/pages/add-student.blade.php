                  ...
                  {{-- <form method="post" action="{{url('save-student')}}" class="flex flex-col space-y-8" enctype="multipart/form-data">
                    ...
                    <div class="flex flex-col space-y-4 md:space-y-0 md:flex-row md:space-x-4">
                        ...
                        <div class="form-item w-full">
                            ...
                            <input type="text" value="{{old('lastname')}}" class="w-full  appearance-none text-black text-opacity-75 rounded shadow py-1 px-2  mr-2 mb-4 focus:outline-none focus:shadow-outline focus:border-blue-200 dark:bg-gray-600 dark:text-white" id="lastname" name="lastname" capitalize>
                            @error('lastname')
                        ...
                        <div class="form-item w-full">
                            ...
                            <input type="text" value="{{old('firstname')}}" class="w-full appearance-none text-black text-opacity-50 rounded shadow py-1 px-2  mr-2 focus:outline-none focus:shadow-outline focus:border-blue-200 dark:bg-gray-600 dark:text-white" id="firstname" name="firstname" capitalize>
                            @error('firstname')
                        ...
                        <div class="form-item w-full">
                            ...
                            <input type="text" value="{{old('middlename')}}" class="w-full appearance-none text-black text-opacity-50 rounded shadow py-1 px-2  mr-2 focus:outline-none focus:shadow-outline focus:border-blue-200 dark:bg-gray-600 dark:text-white" id="middlename" name="middlename" capitalize>
                            @error('middlename')
                    ...
                    <div class="flex flex-col space-y-4 md:space-y-0 md:flex-row md:space-x-4">  
                        ...
                        <div class="form-item w-full">
                            ...
                            <input type="text" value="{{Auth::user()->email}}" class="w-full appearance-none text-black text-opacity-50 rounded shadow py-1 px-2 mr-2 mb-4 focus:outline-none focus:shadow-outline focus:border-blue-200" id="email" name="email " disabled capitalize>
                            @error('email')
                        ...
                        <div class="form-item w-full">
                            ...
                            <input type="text" value="{{old('section')}}" class="w-full appearance-none text-black text-opacity-50 rounded shadow py-1 px-2 mr-2 focus:outline-none focus:shadow-outline focus:border-blue-200 dark:bg-gray-600 dark:text-white" id="section" name="section" capitalize>
                            @error('section')
                    ...
                    <div class="flex flex-col space-y-4 md:space-y-0 md:flex-row md:space-x-4">
                        ...
                        <div class="form-item w-full">
                            ...
                            <input type="text" value="{{old('religion')}}" class="w-full appearance-none text-black text-opacity-50 rounded shadow py-1 px-2 mr-2 focus:outline-none focus:shadow-outline focus:border-blue-200 dark:bg-gray-600 dark:text-white" id="religion" name="religion" capitalize>
                            @error('religion')
                        ...
                        <div class="form-item w-full">
                            ...
                            <input type="text" value="{{old('nationality')}}" class="w-full appearance-none text-black text-opacity-50 rounded shadow py-1 px-2 mr-2 focus:outline-none focus:shadow-outline focus:border-blue-200 dark:bg-gray-600 dark:text-white" id="nationality" name="nationality" capitalize>
                            @error('nationality')
                    ...
                    <div class="flex flex-col space-y-4 md:space-y-0 md:flex-row md:space-x-4">
                        ...
                        <div class="form-item w-full">
                            ...
                            <input type="text" value="{{old('fathersname')}}" class="w-full appearance-none text-black text-opacity-50 rounded shadow py-1 px-2 mr-2 mb-4 focus:outline-none focus:shadow-outline focus:border-blue-200 dark:bg-gray-600 dark:text-white"  id="fathersname" name="fathersname" capitalize>
                            @error('fathersname')
                        ...
                        <div class="form-item w-full">
                            ...
                            <input type="text" value="{{old('foccupation')}}" class="w-full appearance-none text-black text-opacity-50 rounded shadow py-1 px-2 mr-2 focus:outline-none focus:shadow-outline focus:border-blue-200 dark:bg-gray-600 dark:text-white" id="foccupation" name="foccupation" capitalize>
                            @error('foccupation')
                        ...
                        <div class="form-item w-full">
                            ...
                            <input type="text" value="{{old('mothersname')}}" class="w-full appearance-none text-black text-opacity-50 rounded shadow py-1 px-2 mr-2 focus:outline-none focus:shadow-outline focus:border-blue-200 dark:bg-gray-600 dark:text-white" id="mothersname" name="mothersname" capitalize>
                            @error('mothersname')
                        ...
                        <div class="form-item w-full">
                            ...
                            <input type="text" value="{{old('moccupation')}}" class="w-full appearance-none text-black text-opacity-50 rounded shadow py-1 px-2 mr-2 focus:outline-none focus:shadow-outline focus:border-blue-200 dark:bg-gray-600 dark:text-white" id="moccupation" name="moccupation" capitalize>
                            @error('moccupation')
