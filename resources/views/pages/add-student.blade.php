...
<form class="w-full max-w-lg pl-8 pr-8 pt-6 pb-4" method="post" action="{{url('save-student')}}">
    ...
    <div class="flex flex-wrap -mx-3 mb-2">
      ...
      <div class="w-full md:w-1/3 px-3 mb-2">
        ...
        <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-2 px-4 leading-tight focus:outline-none focus:bg-white shadow-lg focus:border-gray-500" id="firstname" name="lastname" type="text">
      </div>
    ...
    <div class="flex flex-wrap -mx-3 mb-2">
      ...
      <div class="flex flex-wrap -mx-3 mb-2">
        ...
        <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
          <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-1" for="fathers-name">
            Fathers Name
          </label>
          <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-2 px-4 mb-3 leading-tight focus:outline-none focus:bg-white shadow-lg" id="fathers-name" name="fathers-name" type="text" >
          {{-- <p class="text-red-500 text-xs italic">Please fill out this field.</p> --}}
        </div>
  
        <div class="w-full md:w-1/2 px-3 mb-2">
          <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-1" for="mothers-name">
            Mothers Name
          </label>
          <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-2 px-4 leading-tight focus:outline-none focus:bg-white shadow-lg focus:border-gray-500" id="mothers-name" name="mothers-name" type="text" >
        </div>
    ...
    <div class="flex flex-wrap -mx-3 mb-6">
      <div class="w-full px-3">
        ...
        <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white shadow-lg focus:border-gray-500" id="address" name="address" type="text">
