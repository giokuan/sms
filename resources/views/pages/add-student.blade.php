...
>>>>>>> 420555d4818dbc098cf2f666d52324ce80ce9d23
                    ...
                    <div class="flex flex-col space-y-4 md:space-y-0 md:flex-row md:space-x-4">  
                        ...
                        <div class="form-item w-full">
                            ...
                            <input type="text" value="{{old('section')}}" class="w-full appearance-none text-black text-opacity-50 rounded shadow py-1 px-2 mr-2 focus:outline-none focus:shadow-outline focus:border-blue-200 dark:bg-gray-600 dark:text-white" id="section" name="section">
                            @error('section')
