    ...
    {{-- <div class="bg-white rounded-md shadow-md dark:bg-dark-eval-1"> --}}
        ...
        <form class="w-full  md:px-40 pt-6 pb-4" method="post" action="{{url('save-student')}}">
            ...
            <div class="w-full md:w-1/3 px-3 mb-2 md:mb-0">
                ...
                <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-2 px-4 mb-3 leading-tight focus:outline-none focus:bg-white shadow-lg" id="lastname" name="lastname" type="text" value="{{old('lastname')}}" >
            ...
            <div class="w-full md:w-1/3 px-3 mb-2">
                ...
                <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-2 px-4 leading-tight focus:outline-none focus:bg-white shadow-lg focus:border-gray-500" id="firstname" name="firstname" type="text" value="{{old('firstname')}}" >
                @error('firstname')
                ...
                <div class="flex p-4 mb-4 text-sm text-red-700 bg-red-100 rounded-lg dark:bg-red-200 dark:text-red-800" role="alert">
                    ...
                    <span class="sr-only">Info</span>
                    <div>
                      <span class="font-medium"> First Name field is required</span> 
                    </div>
                  </div>
            ...
            <div class="flex flex-wrap -mx-3 mb-2">
                ...
                ease-in-out
                m-0
                focus:text-gray-700 focus:bg-white  focus:outline-none shadow-lg" id="formFileLg" type="file">
                </div>
