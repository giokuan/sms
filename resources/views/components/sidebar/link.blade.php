...
@php
    $isActiveClasses =  $isActive ? 'text-white bg-sky-500 shadow-lg hover:bg-sky-700' : 'text-gray-500 hover:text-gray-700 hover:bg-gray-100 dark:hover:text-gray-300 dark:hover:bg-dark-eval-2';  
